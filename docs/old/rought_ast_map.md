...
>         ├─ ".identifier"       ──> Ast.Expression.Access(receiver=Optional.of(primary_expression),
>         │                                                name=identifier)
>         │
>         └─ ".identifier(args)" ──> Ast.Expression.Function(receiver=Optional.of(primary_expression),
>                                                            name=identifier, 
>                                                            arguments=expression(s))
>        [Rule] receiver is analyzed first; member variable/function resolved via receiver.type scope
